...
# --- Force a real IP for Geocoder when running locally ---
module ActionDispatch
  class Request
    def remote_ip
      # Example: pretend all local requests come from Bishkek (Kyrgyzstan)
      "37.110.208.0" # You can use any public IP — e.g., 8.8.8.8 (Google DNS)
    end
  end
end
